...
| <a name="requirement_terraform"></a> [terraform](#requirement\_terraform) | >= 1.5 |
| <a name="requirement_aws"></a> [aws](#requirement\_aws) | ~> 5.8 |
| <a name="requirement_mongodbatlas"></a> [mongodbatlas](#requirement\_mongodbatlas) | >= 1.15.0, < 1.18.0 |
| <a name="requirement_random"></a> [random](#requirement\_random) | >= 3.6.0 |
...
| <a name="provider_mongodbatlas"></a> [mongodbatlas](#provider\_mongodbatlas) | >= 1.15.0, < 1.18.0 |
| <a name="provider_random"></a> [random](#provider\_random) | >= 3.6.0 |
